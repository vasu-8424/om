...
const portfolioItems = [
  {
    ...
    images: [
      { img: '/bhpv employee housing.png', label: 'BHPV — Site View' },
      { img: '/bhpv2.png',                 label: 'BHPV — Phase 2' },
      { img: '/bhpv3.png',                 label: 'BHPV — Phase 3' },
      { img: '/bhpv4.png',                 label: 'BHPV — Phase 4' },
    ],
  },
  {
    id: 'roads',
    ...
    images: [
      { img: '/govt cc roads.png', label: 'CC Roads — Overview' },
      { img: '/cc2.png',           label: 'CC Roads — Section 2' },
      { img: '/cc3.png',           label: 'CC Roads — Section 3' },
      { img: '/cc4.png',           label: 'CC Roads — Section 4' },
    ],
  },
  {
    id: 'mes',
    ...
    images: [
      { img: '/mes.png',                        label: 'MES — Overview' },
      { img: '/military engineer services.png',  label: 'Military Engineer Services' },
      { img: '/mes 2.png',                      label: 'MES — Phase 2' },
      { img: '/mes 3.png',                      label: 'MES — Phase 3' },
      { img: '/mes 4.png',                      label: 'MES — Phase 4' },
    ],
  },
];
